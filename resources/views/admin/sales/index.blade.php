                    ...
                    @foreach($sales as $sale)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <span class="badge badge-light-primary">Inscripción</span>
                                @endif
                            </td>
                            ...
                            <td class="text-end">
                                ...
                                <button 
                                    class="btn btn-sm btn-light-info btn-view-sale me-2"
                                    data-sale='@json($sale)'>
                                    Ver
                                </button>
                                ...
                                @if($sale['type'] === 'ticket')
                                    <a target="_blank"
                                       href="{{ route('admin.ticket_instances.reprint', $sale['instance']) }}"
                                       class="btn btn-sm btn-light-primary">
                                        Reimprimir
                                    </a>
                                @else
                                    <a target="_blank"
                                       href="{{ route('admin.registrations.reprint', $sale['instance']) }}"
                                       class="btn btn-sm btn-light-primary">
                                        Reimprimir
                                    </a>
                                @endif
